...
class HomeViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(NewReleaseCollectionCollectionViewCell.self,
                                forCellWithReuseIdentifier: NewReleaseCollectionCollectionViewCell.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .newReleases(let viewModels):
           guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: NewReleaseCollectionCollectionViewCell.identifier,
                for: indexPath
           ) as? NewReleaseCollectionCollectionViewCell else {
